...
$sql_delete = "DELETE FROM book WHERE Book_ID = $delete_id ";
$sql_delete2 = "DELETE FROM inventory WHERE Book_ID = $delete_id ";
...
echo "<script> {window.alert('刪除成功！');location.href='book.php'} </script>";
?>
